...
- **Predictive Modeling:** Applied feature scaling, 80/20 train-test split, and GridSearchCV tuning to Logistic Regression, SVM, Decision Tree, and KNN. Models averaged 83% test accuracy; Decision Tree stood out with even precision/recall and zero false negatives. _Leading features: orbit (0.35 importance), payload (0.25)._
